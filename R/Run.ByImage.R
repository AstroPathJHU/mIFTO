#################################GUI#####################################
#'Main funtion to start analysis on a by image basis. Creates the gui and calls other functions within the package for processing
#'
#'RUN.ByImage
