...
#' @export
#'
map_ttest_plots <- function(
  wd, Antibody_Opal,Slide_Descript, Concentration, Tables,
  theme1, colors) {
  #
  ...
  for(z in correction.val.name){
    ...
    plots[[p_count]]<-ggplot2::ggplot(
      ...
      ggplot2::labs(title=paste0(
        "Welch's t-Test statistics of ",zn,
        '\n Averaged Across Slides for \n', Antibody_Opal),
